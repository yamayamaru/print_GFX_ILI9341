...
int main() {
    ...
    // printGFX_ILI9341のdrawPalette256Bitmapで使用するパレットをweb safe color 216にする
...
// print_GFX_GFXcanvas8のインクルード
#include "print_GFX_GFXcanvas8.h"
// fontデータのインクルード
#include "glcdfont_tt24.h"

print_GFX_GFXcanvas8 canvas01 = print_GFX_GFXcanvas8(ILI9341_TFTWIDTH, ILI9341_TFTHEIGHT);
    // print_GFX_GFXcanvas8はメモリ上の確保したフレームバッファ上に描画するクラスです。
    // print_GFX_GFXcanvas8でメモリ上に書き込んだうえで
    // print_GFX_ILI9341もしくはyama_2_GFX_ILI9341のdrawPalette256Bitmap()で
    // 実際にILI9341のLCDにフレームバッファのメモリの内容を
    // 一度に書き込むことで高速に描画ができます。
    // print_GFX_GFXcanvas8を使う場合はCMakeLists.txtのadd_executableに
    // print_GFX_GFXcanvas8.cppを追加するのを忘れないようにしてください
...
void setup(void){
    ...
    canvas01.set_font_color(WEB216_PALETTE_MAGENTA, WEB216_PALETTE_BLACK);
...
void random_raspberry(void) {
    ...
    // GFXcanvas8のバッファの上の座標x=0、y=0に文字を表示
    canvas01.set_font_pos(0,0);
...
const uint8_t bitmap_mask01[] = {         // 64x64 8ビットカラー画像マスク
...
const uint8_t bitmap01[] = {         // 64x64 8ビットカラー画像(web216パレット)
    0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
    0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
    0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
    0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
