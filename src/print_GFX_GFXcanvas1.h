...
#ifndef _PRINT_GFX_GFXcanvas1_H
#define _PRINT_GFX_GFXcanvas1_H
...
#define _PRINT_GFX_GFXcanvas1_STR_BUFF01_LEN01 2047
#ifndef _PRINT_GFX_GFXcanvas1_MAX_TEXT_SIZE01
#define _PRINT_GFX_GFXcanvas1_MAX_TEXT_SIZE01  2047
#endif

#include "font_class.h"

extern glcdfont_dummy glcdfont_dummy_print_GFX_GFXcanvas1;

class print_GFX_GFXcanvas1 : public GFXcanvas1{
struct colormap {
    uint16_t fg;
    uint16_t bg;
};
...
protected:
    ...
    char str_buff01[_PRINT_GFX_GFXcanvas1_STR_BUFF01_LEN01 + 1];

public:

    print_GFX_GFXcanvas1(int16_t w, int16_t h);
