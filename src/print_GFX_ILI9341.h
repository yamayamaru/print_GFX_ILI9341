...
#ifndef _PRINT_GFX_ILI9341_H
#define _PRINT_GFX_ILI9341_H
...
#define _PRINT_GFX_ILI9341_STR_BUFF01_LEN01 2047
#ifndef _PRINT_GFX_ILI9341_MAX_TEXT_SIZE01
#define _PRINT_GFX_ILI9341_MAX_TEXT_SIZE01  2047
#endif

extern glcdfont_dummy glcdfont_dummy_print_GFX_ILI9341;

class print_GFX_ILI9341 : public yama_2_GFX_ILI9341{
struct colormap {
    uint16_t fg;
    uint16_t bg;
};
...
protected:
    ...
    char str_buff01[_PRINT_GFX_ILI9341_STR_BUFF01_LEN01 + 1];

public:

    print_GFX_ILI9341(spi_inst_t *inst, int32_t dc, int32_t rst, int32_t cs);
