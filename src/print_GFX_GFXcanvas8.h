...
#ifndef _PRINT_GFX_GFXcanvas8_H
#define _PRINT_GFX_GFXcanvas8_H
...
#define _PRINT_GFX_GFXcanvas8_STR_BUFF01_LEN01 2047
#ifndef _PRINT_GFX_GFXcanvas8_MAX_TEXT_SIZE01
#define _PRINT_GFX_GFXcanvas8_MAX_TEXT_SIZE01  2047
#endif

#include "font_class.h"

extern glcdfont_dummy glcdfont_dummy_print_GFX_GFXcanvas8;

class print_GFX_GFXcanvas8 : public GFXcanvas8{
struct colormap {
    uint16_t fg;
    uint16_t bg;
};
...
protected:
    ...
    char str_buff01[_PRINT_GFX_GFXcanvas8_STR_BUFF01_LEN01 + 1];

public:

    print_GFX_GFXcanvas8(int16_t w, int16_t h);
